...
const styles = {
  ...
  navItem: `relative mr-1 cursor-pointer hove:opacity-60`,
  navLink: `text-white flex mx-[10px]`,
  badge: `rounded-full bg-blue-600 h-1 w-1 absolute bottom-55 right-0 top-1 ring-4`,
  inputContainer: `flex items-center justify-center p-2 rouned-bg-[#171924]`,
